		...
		jQuery('#calendar').fullCalendar({
			...
			foreach($booked_dates as $booking):
				 ...
				 ?>
				{
					...
					start: new Date(date('Y'), <?php echo $booking_engine->date_from_mysql($booking->checkin,'m')-1; ?>, <?php echo $booking_engine->date_from_mysql($booking->checkin,'d'); ?>),
					end: new Date(date('Y'), <?php echo $booking_engine->date_from_mysql($booking->checkout,'m')-1; ?>, <?php echo $booking_engine->date_from_mysql($booking->checkout,'d')-1; ?>)				
